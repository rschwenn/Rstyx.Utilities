...
'Namespace System.Threading.Tasks.Schedulers
	...
	Public NotInheritable Class StaTaskScheduler
		...
		Public Sub New(NumberOfThreads As Integer)
			...
			If (NumberOfThreads < 1) Then Throw New ArgumentOutOfRangeException("numberOfThreads")
			...
			_threads = Enumerable.Range(0, NumberOfThreads).[Select](Of Thread)(Function(i)
